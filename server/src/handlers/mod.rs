...
pub fn router(state: AppState) -> Router {
    let api = Router::new()
        ...
        .route(
            "/guilds/{guild_slug}/moderation/reports/messages/{message_id}",
            post(moderation::create_message_report),
        )
        .route(
            "/guilds/{guild_slug}/moderation/reports/users/{target_user_id}",
